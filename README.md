...
- расписание и объединённая лента дня; администратор и редактор класса могут
  добавлять и менять еженедельные уроки, а также оформлять отмены, замены и
  дополнительные уроки на выбранную дату;
